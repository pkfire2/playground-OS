...
before you start making your own creations, you'll need to install a software called Love2D. It's the framework this project is built on and you'll need it to run your code. (availible at love2d.org)
